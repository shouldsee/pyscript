...
def gillespie_LV(s0,t_obs_out,param):
    ...
    while t < t_final:
        ...
        types=['H birth','H death','L birth','L death']
        ...
        rates=[rate_Hbirth,rate_Hdeath,rate_Lbirth,rate_Ldeath]
        ...
        if event_type=="H birth":
            H+=1
        elif event_type=="H death":
            H+=-1
        elif event_type=="L birth":
            L+=1
        elif event_type=="L death":
            L+=-1
        else:
...
area = 100
# numbers
H0=int(density_H*area)
L0=int(density_L*area)

# specify parameter values
k1=0.75
k2=0.3/area # larger area implies fewer interactions
eff=0.02
k3=1.0/3.0
...
output=multiprocess(gillespie_LV,   1,     fn_args=(s0,t_obs,param) )
