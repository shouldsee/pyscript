...
def gillespie_logistic(s0,t_obs_out,param):

    #--0--# Unpack parameters and species variables

    k_birth, k_death, k_competition = param
    N, = s0
    ...
    while t < t_final:
        ...
        rate_birth = k_birth*N
        rate_death = k_death*(N + k_competition*N*N)
...
k_birth=0.03
k_death=0.01
k_competition=0.00005

s0=(N0,)
param=(k_birth, k_death, k_competition)
...
output=multiprocess(gillespie_logistic,   1,     fn_args=(s0,t_obs,param) )
