...
class html_report:
    ...
    def add_figure(self,fig,caption="",verbose=True):
        ...
        png_output=base64.b64encode(png_output.getvalue()).decode();
    ...
    def add_source(self,code_filename=None,caption='',verbose=True):
        ...
        with open(code_filename,'r') as infile:
            ...
            # code=cgi.escape(code).encode('ascii', 'xmlcharrefreplace').decode()
...
# test.add_text("here")
# test.add_heading("TITLE")
# para11='''Here we analyse the behavior of Lokta-Volterra Model. The '''
# test.add_text(para1)
# test.write()
# test.view()
