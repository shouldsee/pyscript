...
from webbrowser import open as open_new
...
class html_report:
    ...
    fig_template="<figure><figcaption>{caption}</figcaption><img src='data:image/png;base64,{imgdata}'/></figure><br/>\n"
    ...
    def add_text(self,text,tag='div',tag_class=None,verbose=False):
    ...
    def add_heading(self,text,tag='h2',tag_class=None,verbose=False):
        self.add_text(text,tag,tag_class,verbose)

    def add_subheading(self,text,tag='h3',tag_class=None,verbose=False):
        self.add_text(text,tag,tag_class,verbose)

    def add_code(self,text,tag='pre',tag_class=None,verbose=False):
        self.add_text(text,tag,tag_class,verbose)


    def add_figure(self,fig,caption="",verbose=False):
    ...
    def add_animation(self,my_animation,caption='',verbose=False):
    ...
    def add_source(self,code_filename=None,caption='',verbose=False):
